...
class TestParseFilename:
    ...
    def test_author_title_year_narrator(self):
        meta = parse_filename("George Orwell - Animal Farm (1945) [Voice Actor]")
    ...
    def test_author_title_only(self):
        meta = parse_filename("Steven Levy - Hackers")
    ...
    def test_title_author_year(self):
        ...
        meta = parse_filename("Animal Farm - George Orwell (1945)")
    ...
    def test_series_with_volume(self):
        meta = parse_filename("Terry Goodkind - Sword of Truth Vol 2 - Stone of Tears")
